                                ...
                                <Grid container spacing={3}>
                                    ...
                                    <Grid item xs={12} md={3}>
                                        <MDBox display="flex" flexDirection="column" alignItems="center" textAlign="center">
                                            <MDBox display="flex" alignItems="center" justifyContent="center" width={120} height={120} borderRadius="50%" bgcolor="primary.main" mb={2} sx={{ boxShadow: 2 }}>
