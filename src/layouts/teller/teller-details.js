        ...
        return (
            <MDBox p={3}>
                <MDTypography variant="h6" color="error">
                    No teller data found!
                </MDTypography>
            </MDBox>
        );
    }

    const user = tellerData.user || {};
    const wallet = tellerData.wallet || {};
    const transactions = tellerData.transactions || {};
    const businessType = tellerData.business_type || {};
                                    ...
                                    <Grid item xs={12} md={3}>
                                        ...
                                        >
                                            ...
                                            <MDTypography variant="button" color="text" fontWeight="medium">
                                                teller ID: {tellerData.teller_id || "N/A"}
                                            </MDTypography>
                                            <MDTypography variant="button" color="text" fontWeight="medium">
                                        ...
                                        <Grid container spacing={2}>
                                            ...
                                            <Grid item xs={12}>
                                                <MDBox mb={2}>
                                                    ...
                                                    <MDBox display="flex" flexDirection="column" gap={1}>
                                                        <MDTypography variant="button" color="text" fontWeight="medium">
                                                            Business Name: {tellerData.name || "N/A"}
                                                        </MDTypography>
                                                        <MDTypography variant="button" color="text" fontWeight="medium">
                                                            Business Code: {businessType.code || "N/A"}
                                                        </MDTypography>
                                                        <MDTypography variant="button" color="text" fontWeight="medium">
                                                            Address: {tellerData.address || "N/A"}
                                                        </MDTypography>
                                                    </MDBox>
                                                </MDBox>
                                            </Grid>
                                            ...
                                            <Grid item xs={12}>
                                                <MDBox mt={2}>
                                                    ...
                                                    <MDBox display="flex" flexWrap="wrap" gap={3}>
                                                        {[
                                                            { label: "Business Certificate", link: tellerData.business_cert },
                                                            { label: "Brella Certificate", link: tellerData.brella_cert },
                                                            { label: "TIN Certificate", link: tellerData.tin_cert },
                                                        ].map((doc, index) => (
                                                            <MDTypography
                                                                key={index}
                                                                variant="button"
